<script src="../../ckeditor/ckeditor.js"></script>
	...
	<div id="content">
		<form name="orderForm" id="orderForm" method="post" enctype="multipart/form-data" action="/bbs/write_news" onsubmit="return formSubmit();">
					...
					<table class="board_list write">
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="file" class="" value="" name="upFile" id="upFile" /></td>
							</tr>
						</tbody>
					</table>
